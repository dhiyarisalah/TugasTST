...
def initial(jenis_kelamin, jumlah_huruf_minimal, jumlah_huruf_maksimal, jumlah_nama):
    # jenis_kelamin = eval(input("Pilih jenis_kelamin anak (L/P) "))
    # jumlah_huruf_minimal = eval(input("Minimal berapa huruf? "))
    # while jumlah_huruf_minimal< 2:
    #     jumlah_huruf_minimal = eval(input("Minimal berapa huruf? "))
    # jumlah_huruf_maksimal = eval(input("Maksimal berapa huruf? "))
    # jumlah_nama = eval(input("Mau berapa jumlah nama yang direkomendasikan? "))

    # self.jenis_kelamin = jenis_kelamin
    # self.jumlah_huruf_minimal = jumlah_huruf_minimal
    # self.jumlah_huruf_maksimal = jumlah_huruf_maksimal
    # self.jumlah_nama = jumlah_nama
